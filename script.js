const events=[
{year:"1830",title:"O início ... 1830",photo:"photo-1830",text:["Nas primeiras décadas do século XIX, São Paulo ainda era marcada pela Faculdade de Direito.","O ato de criação ocorreu em 15 de dezembro de 1831, com efetivo inicial de 100 homens a pé e 30 a cavalo."]},
...
function renderEvent(i){
  ...
  document.getElementById("eventImage").className="fake-photo "+e.photo;
